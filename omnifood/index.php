...
<head>
    <meta charset="utf-8">
    <meta name="description" content="Omnifood is a premium food delivery service with the mission 
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;1,300&display=swap">
...
<body>
    <header>
        ...
        <div class="hero-text-box">
            <h1>Goodbye junk food.<br> Hekki super healthy meals.</h1>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box js--wp-4">
                    <div>
                        ...
                        <p class="plan-price-email">That’s only 13.30$ per meal</p>
                    </div>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    <div>
                        ...
                        <p class="plan-price-email">That’s only 14.90$ per meal</p>
                    </div>
